...
//Cuando se tiene solo una linea despues del if no se agregan llaves de lo contrario si
//toupper=cambia de minúscula a mayúscula y viceversa
...
//Agregamos datos al archivo
	...
	ofstream archivo; 
	//Manejo de errores///*try {*/archivo.open("aseguradora.txt",ios::app);
